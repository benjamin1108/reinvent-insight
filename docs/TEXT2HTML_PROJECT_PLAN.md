...
|--------|----------|----------|---------|------|----------|----------|------|
| P1.1 | 创建Text2HtmlGenerator核心类 | 1天 | - | ⏸️ 待开始 | - | - | 包括基础结构和配置加载 |
| P1.2 | 设计AI提示词模板系统 | 1天 | - | ⏸️ 待开始 | - | - | 基于text2html.txt优化 |
| P1.3 | 实现单文件转换功能 | 1.5天 | - | ⏸️ 待开始 | - | - | 包括内容清理和AI调用 |
| P1.4 | 创建文件存储管理机制 | 0.5天 | - | ⏸️ 待开始 | - | - | insights目录和元数据管理 |
| P1.5 | 开发基础CLI工具 | 1天 | - | ⏸️ 待开始 | - | - | generate_insights.py脚本 |
| P1.6 | 实现错误处理和重试机制 | 1天 | - | ⏸️ 待开始 | - | - | 3次重试+指数退避 |

**Phase 1 里程碑**: ✅ 能够通过CLI命令成功将单个markdown文件转换为HTML

### Phase 2: API与检查机制 (预计2-3天)

| 任务ID | 任务描述 | 预计时间 | 负责人 | 状态 | 开始日期 | 完成日期 | 备注 |
|--------|----------|----------|---------|------|----------|----------|------|
| P2.1 | 新增API端点/articles/{id}/insight | 1天 | - | ⏸️ 待开始 | - | - | 检查Quick-Insight文件是否存在 |
| P2.2 | 实现文章ID与文件名映射逻辑 | 0.5天 | - | ⏸️ 待开始 | - | - | 复用现有hash系统 |
| P2.3 | 开发Quick-Insight文件元数据管理 | 0.5天 | - | ⏸️ 待开始 | - | - | JSON元数据文件格式 |
| P2.4 | API接口测试与文档 | 1天 | - | ⏸️ 待开始 | - | - | 完整的API测试覆盖 |

**Phase 2 里程碑**: ✅ API能够准确检查和返回文章的Quick-Insight模式可用性

### Phase 3: 前端UI集成 (预计3-4天)

| 任务ID | 任务描述 | 预计时间 | 负责人 | 状态 | 开始日期 | 完成日期 | 备注 |
|--------|----------|----------|---------|------|----------|----------|------|
| P3.1 | 设计模式切换UI组件 | 1天 | - | ⏸️ 待开始 | - | - | 基于TechButton的切换器 |
| P3.2 | 在ReadingView中集成API调用 | 1天 | - | ⏸️ 待开始 | - | - | 检查Quick-Insight模式可用性 |
| P3.3 | 实现HTML内容渲染逻辑 | 1天 | - | ⏸️ 待开始 | - | - | 替换markdown渲染 |
| P3.4 | 优化切换动画和加载状态 | 0.5天 | - | ⏸️ 待开始 | - | - | 平滑的用户体验 |
| P3.5 | 移动端适配和响应式优化 | 0.5天 | - | ⏸️ 待开始 | - | - | 确保移动端正常显示 |

**Phase 3 里程碑**: ✅ 用户可以在前端无缝切换两种阅读模式
...
| 里程碑 | 目标日期 | 状态 | 完成情况 |
|--------|----------|------|----------|
| Phase 1 完成 | 第1周结束 | ⏸️ | 0/6 任务完成 |
| Phase 2 完成 | 第2周结束 | ⏸️ | 0/4 任务完成 |
| Phase 3 完成 | 第2-3周 | ⏸️ | 0/5 任务完成 |
| Phase 4 完成 | 第3-4周 | ⏸️ | 0/5 任务完成 |
| 项目完成 | 第4周结束 | ⏸️ | 0/25 任务完成 |
