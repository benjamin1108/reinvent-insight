...
### Problem Definition（破题）
- 直接抛出工程难题或技术瓶颈（The Engineering Challenge）
- 不要讲故事，要讲"约束条件"
- 例如："在 SnapStart 出现之前，JVM 的启动机制与 Serverless 的瞬时扩缩容特性之间，存在着本质的架构冲突。"
...
- **技术逻辑闭环**：针对技术解读，必须补齐 "Why(为何做) -> What(原理是什么) -> How(如何落地)" 的完整链条，若原文缺失需基于常识适当补充
- 技术细节要解释清楚，不要一句话带过
- 所有论述必须有原文支撑，不要编造
